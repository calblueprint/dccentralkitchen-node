...
export const Columns = {
  ...
  Stores: {
    ...
    salesDatIds: { name: `Sales Data`, type: `foreignKey-many` },
    currentProducts: { name: `Current Products`, type: `lookup` },
    importedProductIds: { name: `Imported Products`, type: `foreignKey-many` },
  },
  Products: {
    primaryKey: { name: `Primary Key`, type: `formula` },
    ...
    storesIds: { name: `Stores 2`, type: `foreignKey-many` },
  },
  'Line Items': {
    primaryKey: { name: `Primary Key`, type: `formula` },
  ...
  Sales: {
    ...
    produceIteIds: { name: `Produce Item`, type: `foreignKey-many` },
    submission: { name: `Submission`, type: `text` },
    driver: { name: `Driver`, type: `text` },
  },
};
