...
export const getStoresBySnapOrEbtAccepted = async (
  value,
  filterByFormula = '',
  sort = []
) => {
  return getRecordsByAttribute(
    Tables.Stores,
    Columns[Tables.Stores].snapOrEbtAccepted.name,
    value,
    filterByFormula,
    sort
  );
...
export const getProductsByPoints = async (
  value,
  filterByFormula = '',
  sort = []
) => {
  return getRecordsByAttribute(
    Tables.Products,
    Columns[Tables.Products].points.name,
    value,
    filterByFormula,
    sort
  );
